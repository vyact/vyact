import {normalizeKokoroVoices} from './kokoroVoice';
...
export interface TtsSettings {
    ...
    kokoroVoices?: Record<string, string>;
...
export async function fetchTtsSettings(): Promise<TtsSettings> {
    try {
        ...
        _cache = {
            ...
            kokoroVoices: normalizeKokoroVoices(data.kokoroVoices, data.kokoroVoice || 'af_heart'),
        };
    } catch {
