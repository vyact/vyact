            ...
            {hasServiceKey && <div className="external-data-sync-panel">
                ...
                {isAllSyncing && <div className="external-data-overall-progress">{supportedEnabledSources.map(source => {
                    ...
                    const errorMessage = status.error_code === 'request_limit_exceeded'
                        ? t(source.id === 'welfare' ? 'externalData.welfare.requestLimitExceeded' : 'externalData.requestLimitExceeded')
                        : t(source.id === 'welfare' ? 'externalData.welfare.syncFailed' : source.id === 'housing' ? 'externalData.housing.syncFailed' : 'externalData.syncFailed');
