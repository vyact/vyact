...
ใช้ AI บนเครื่องกับเอกสาร อีเมล และเบราว์เซอร์ ตั้งแต่ค้นหาคำตอบในไฟล์ ไปจนถึงร่างอีเมลตอบกลับและปรับปรุงงานเขียน
...
[![ชมเดโม 30 วินาที](assets/readme/demo-local-document-dark.png)](https://youtu.be/6_6ChdrW8lY)
...
ใช้ส่วนขยาย Chrome เพื่อตรวจการสะกดและไวยากรณ์ขณะเขียนโพสต์ อีเมล หรือความคิดเห็น จุดที่แนะนำให้แก้ไขจะมีเส้นใต้ในข้อความ ส่วน**แนะนำคำ**จะแสดงเป็นสีม่วงเมื่อเปิดใช้งาน เปิดคำแนะนำเพื่อดูตัวอย่างการเปลี่ยนแปลง แล้วเลือกใช้หรือละเว้นได้โดยไม่ต้องออกจากหน้าเว็บ

เปิด**เหตุผลที่แก้ไข**เพื่อดูว่าทำไมจึงแนะนำให้เปลี่ยนข้อความ การแนะนำคำและคำอธิบายจะปิดไว้ตามค่าเริ่มต้น คุณจึงเปิดเฉพาะสิ่งที่ต้องการได้ เมนูเดียวกันนี้ยังให้คุณใช้หรือละเว้นคำแนะนำทีละรายการหรือทั้งหมด เลิกทำการแก้ไข และเปิดหรือปิด**ตรวจอัตโนมัติ**ได้
...
| 🗂️ | เชื่อมต่อ Google และ Microsoft | ใช้ Gmail, Outlook, Google Drive, OneDrive และปฏิทิน |
...
- **การเชื่อมต่อ Microsoft** — ที่ **การตั้งค่า > Microsoft** ให้ป้อน Client ID ของแอปที่ลงทะเบียนใน Microsoft Entra และทำตามคู่มือการตั้งค่าเพื่อเข้าสู่ระบบ แล้วใช้อีเมล Outlook ไฟล์ OneDrive และปฏิทิน Microsoft
- **สลับบัญชี** — สลับระหว่างบัญชี Google และ Microsoft ที่เชื่อมต่อ กด **Cmd+Shift+G** บน macOS หรือ **Ctrl+Shift+G** บน Windows/Linux เพื่อเปิดหรือปิดแผงอีเมล ไฟล์ และปฏิทิน
...
- **สำรองข้อมูลสำคัญ** — export และ restore บทสนทนา เอกสาร ไฟล์ โน้ต prompt การตั้งค่า การเชื่อมต่อ project และคำศัพท์ รวมถึงบันทึกบน Google Drive หรือ OneDrive
...
4. เชื่อม Google หรือ Microsoft จาก **การตั้งค่า > Google** หรือ **การตั้งค่า > Microsoft** หรือติดตั้งส่วนขยาย Chrome
