...
Vyact คือพื้นที่ทำงานบนเดสก์ท็อปสำหรับ AI บนเครื่อง ค้นหาคำตอบในเอกสาร ร่างอีเมลตอบกลับ และปรับปรุงงานเขียนในเบราว์เซอร์ด้วยโมเดลที่คุณเลือก
...
[เริ่มต้นใช้งาน](#เริ่มจากเอกสารหนึ่งฉบับ) · [ขั้นตอนการทำงาน](#พื้นที่ทำงานเดียวสำหรับงานประจำวัน) · [คุณสมบัติ](#ทุกสิ่งที่ช่วยให้คุณทำงานต่อเนื่องในบริบทเดิม) · [สนับสนุน Vyact](#สนับสนุน-vyact) · [ร่วมพัฒนา](CONTRIBUTING.md)
</div>
...
2. เลือก **Vyact** เพื่อใช้โมเดลบนเครื่อง เปรียบเทียบหน่วยความจำที่คาดว่าจะใช้กับหน่วยความจำของคอมพิวเตอร์ ดาวน์โหลดโมเดล และรอให้เตรียมรันไทม์เสร็จ หรือเลือกผู้ให้บริการ AI ที่ใช้อยู่แล้ว
...
[ข้อกำหนดและวิธีติดตั้งสำหรับแต่ละแพลตฟอร์ม](#เริ่มต้นใช้งาน)

เมื่อใช้โมเดลบนเครื่องที่ Vyact จัดการ บริบทแชต AI จะประมวลผลบนคอมพิวเตอร์ของคุณ หากเลือก AI บนคลาวด์ ข้อมูลที่จำเป็นต่อคำขอจะถูกส่งไปยังผู้ให้บริการนั้น ส่วนการเชื่อมต่ออีเมลและไฟล์จะสื่อสารกับบริการของตนเอง

## เริ่มต้นใช้งาน

<details>
<summary>รายละเอียดการติดตั้งและการเชื่อมต่อ</summary>
...
## เลือกและปรับแต่งโมเดลบนเครื่อง
...
<details>
<summary>รายละเอียดการเร่งความเร็ว MLX</summary>
...
<details>
<summary>รายละเอียดการทดสอบประสิทธิภาพ</summary>
...
<details>
<summary>ดูคุณสมบัติและการเชื่อมต่อทั้งหมด</summary>
...
| ✍️ | ผู้ช่วยเขียนบนเบราว์เซอร์ | ดูคำแนะนำที่ขีดเส้นใต้แล้วเลือกใช้หรือละเว้นทีละรายการหรือทั้งหมด เปรียบเทียบข้อความที่เขียนใหม่ก่อนใช้หรือคัดลอก |
