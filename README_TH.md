...
**Vyact คือพื้นที่ทำงาน AI ส่วนบุคคลแบบโอเพนซอร์สที่ให้ความสำคัญกับการประมวลผลภายในเครื่อง รองรับ llama.cpp, RAG, AI agent, ระบบวิเคราะห์เอกสาร และการเชื่อมต่อ Google Workspace และ Microsoft**
