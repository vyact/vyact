...
| 플랫폼 | 로컬 LLM | Elasticsearch | Kokoro TTS |
| --- | --- | --- | --- |
| macOS (Apple Silicon) | 로컬 모델 사용 시에만 [Ollama](https://ollama.com/download) | 컨테이너형은 Docker Desktop, 설치형도 지원 | [Homebrew](https://brew.sh/)로 `espeak-ng` 설치 |
| Windows | 로컬 모델 사용 시에만 [Ollama](https://ollama.com/download) | 컨테이너형은 Docker Desktop, 설치형도 지원 | [Chocolatey](https://chocolatey.org/) 또는 `winget`으로 `espeak-ng` 설치 |
