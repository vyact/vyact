...
[![문서·이메일·브라우저 통합 데모 보기](assets/readme/demo-local-document-dark.png)](https://youtu.be/5EdlX2hIB-c)

**1분 53초 통합 데모:** 문서 질의응답과 원문 근거 확인, 이메일 서명과 AI 답장 작성, 브라우저 교정 패널과 밑줄별 적용을 보여줍니다. 가상의 자료를 사용한 실제 Vyact 녹화이며, 대기 구간을 편집했고 문서 답변 생성에는 2배속 장면이 포함됩니다.
