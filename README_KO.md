...
[![로컬 9B 모델의 문서 활용 데모 보기 — 28초](assets/readme/demo-local-document.jpg)](https://youtu.be/k3awr5jAdMk)

**28초 데모:** 샘플 문서에서 출시 위험·담당자·대안을 질문하고, 답변의 원문 근거를 확인합니다. Qwen3.5-9B Q4_K_M을 사용한 실제 Vyact 녹화이며, 가상의 자료를 사용했습니다. 대기 구간을 편집했고 답변 생성 장면은 2배속입니다.

아래 기능은 과제 사이트에 등록한 스크린샷과 같은 순서로 소개합니다.
